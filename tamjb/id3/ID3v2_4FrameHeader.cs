...
namespace byteheaven.id3
{
   ...
   ///
   /// This parses version 2.3 and 2.4 frame headers. It will also
   /// gracefully fail to find any useful tags in version2.2 headers.
   /// For those, please use the ID3v2_2FrameHeader class.
   ///
   /// Frame ID      $xx xx xx xx  (four characters)
   /// Size      4 * %0xxxxxxx
   /// Flags         $xx xx
   ///
   public class ID3v2_4FrameHeader
      : ID3v2FrameHeader
   {
      ...
      ///
      public ID3v2_4FrameHeader( byte [] buffer )
      {
