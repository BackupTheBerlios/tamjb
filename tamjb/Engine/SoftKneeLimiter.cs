...
namespace byteheaven.tamjb.Engine
{
   ...
   ///
   /// Soft limiter that I started by copying the Limiter, and never
   /// finished. OK?
   ///
   public class SoftKneeLimiter : SoftKneeDevice, IAudioProcessor
   {
      public double limit 
      {
         set
      ...
      public void Process( ref double left, ref double right )
      {
         ...
         // TODO: add true exponential decay when it's efficient.
      ...
      // This should give a very poor approximation of a 10 ms release
      // time. Did I mention that it's very poor?
      double _gainKeep = 0.999;
      double _gainChange = 0.001;
