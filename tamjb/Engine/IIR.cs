...
namespace byteheaven.tamjb.Engine
{
   ...
   ///
   /// A generic IIR processor for testing filters before they are
   /// optimised into high-performance form.
   /// 
   public class IIR
      : IMonoFilter
   {
      ///
      /// \param coefficients Is the array of coefficients. 
      ///   coefficients[0] is applied to the oldest sample.
      ///
      public IIR( double [] coefficients, 
